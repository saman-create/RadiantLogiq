...
export function Header() {
  ...
  return (
    <header
      className={`site-header ${isOverHero ? "is-over-hero" : "is-after-hero"}${isHeroScrolled ? " is-hero-scrolled" : ""}`}
    >
      ...
      {menuOpen && (
        ...
        >
          <nav aria-label="Mobile menu">
            ...
            <a className="button button-dark" href="/demo" onClick={closeMenu}>
              Request Demo
            </a>
          </nav>
        </div>
